    ...
    <section class="vh-100 gradient-custom text">
        <div class="container py-2 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                {
                    if ($_SESSION['alert_exist_createadmin'])
                    {
                    ...
                    if ($_SESSION['alert_failure_createadmin'])
                    {
                    ...
                    if ($_SESSION['alert_createadmin_invalid_telephone'])
                    {
                    ...
                    if ($_SESSION['alert_createadmin_invalid_password'])
                    {
                    ...
                    if ($_SESSION['alert_createadmin_not_image'])
                    {
                    ...
                    if ($_SESSION['alert_createadmin_image_under_2mb'])
                    {
                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-1">
                                ...
                                <p class="text-white-50 mb-5">پنل ایجاد ادمین</p>
                                ...
                                <button name="btn_create_admin" type="submit" class="btn btn-outline-light btn-lg px-5">ایجاد</button>

    ...
    <section class="vh-100 gradient-custom text">
        <div class="container py-2 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                {
                    if ($_SESSION['alert_exist_createuser'])
                    {
                    ...
                    if ($_SESSION['alert_failure_createuser'])
                    {
                    ...
                    if ($_SESSION['alert_createuser_invalid_telephone'])
                    {
                    ...
                    if ($_SESSION['alert_createuser_invalid_password'])
                    {
                    ...
                    if ($_SESSION['alert_createuser_not_image'])
                    {
                    ...
                    if ($_SESSION['alert_createuser_image_under_2mb'])
                    {
                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-1">
                                ...
                                <p class="text-white-50 mb-5">پنل ایجاد کاربر</p>
                                ...
                                <button name="btn_create_user" type="submit" class="btn btn-outline-light btn-lg px-5">ایجاد</button>
